This is a prototype for Pokemon Utility software. The idea is to create a one-stop program that provides information for anything from a Pokemon's base stats to breeding information to a shiny counter.
